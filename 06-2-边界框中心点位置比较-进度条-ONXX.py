...
# model.export(format="onnx")  # creates 'yolo11n.onnx'
onnx_model = YOLO("D:/Test_File/Code/Zebrafish-NTT-AI-Model/runs/detect/Fish-with-backline4 (best for now)/weights/best.onnx")
...
# Run inference on each image and display results
    for image_file in image_files:
        results = onnx_model(image_file)  # list of Results objects
